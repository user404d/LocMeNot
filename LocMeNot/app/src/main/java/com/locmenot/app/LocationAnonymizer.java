...
import com.locmenot.app.NearbyPlaces.ConvertPlaceTypes;
import com.locmenot.app.NearbyPlaces.FindNearbyPlaces;
import com.locmenot.app.NearbyPlaces.PlaceAttributes;
import com.locmenot.app.models.Semantics;
import com.locmenot.app.models.Session;
import com.locmenot.app.models.Trace;
...
public class LocationAnonymizer implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    com.locmenot.app.models.Location currentLoc;
    ...
    public LocationAnonymizer(Context context, AnonymizationService anonymizationService, Integer kValue) throws ExecutionException, InterruptedException {
        ...
        currentLoc = new com.locmenot.app.models.Location();
        ...
        try {
            ...
            if(!realm.isClosed()) {
                ...
                realm.where(Session.class).findFirst().getMobilityTrace()
                        .add(new com.locmenot.app.models.Location()
    ...
    public void onLocationChanged(final Location location) {
        ...
        Session session = realm.where(Session.class).findFirst();
        RealmList<com.locmenot.app.models.Location>
