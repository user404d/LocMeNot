...
import com.locmenot.app.PreferenceUI.PreferenceList;
    ...
    View.OnClickListener activateMockLocations = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (!activated) {
                ...
                for(com.locmenot.app.models.Location loc : session.getMockLocations()) {
                    Log.i("Fake tracked: ",
                            String.valueOf(loc.getLat()) + ", " + String.valueOf(loc.getLong()));
                }

                for(com.locmenot.app.models.Location loc : session.getRealLocations()) {
                    Log.i("Real tracked: ",
                            String.valueOf(loc.getLat()) + ", " + String.valueOf(loc.getLong()));
                }
            }
